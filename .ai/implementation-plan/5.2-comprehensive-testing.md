...
- *Tasks*:
  ...
  - [x] **Real-time update**: Mark task as in_progress when starting
  - [ ] Create integration test suite that tests full workflows:
    - [x] **End-to-end offchain workflow**:
      ...
      - [x] **COMMIT**: `test: add integration tests for offchain workflow`
    - [x] **End-to-end onchain workflow**:
      ...
      - [x] **COMMIT**: `test: add integration tests for onchain workflow`
    - [ ] **Mixed workflow tests**:
      ...
      - [ ] **COMMIT**: `test: add integration tests for mixed workflows and error scenarios`
  ...
  - [ ] **Final commit checkpoint**: `test: complete integration test suite for SDK workflows`. Add commit hash here!
  ...
  - [ ] **EXPLICIT REQUIREMENT**: Create manual test scripts for real blockchain testing:
    - [ ] `examples/test-real-onchain-workflow.ts`:
      ...
      - [ ] **COMMIT**: `test: add real onchain workflow test script`
    - [ ] `examples/test-real-mixed-workflows.ts`:
      ...
      - [ ] **COMMIT**: `test: add real mixed workflow test script`
