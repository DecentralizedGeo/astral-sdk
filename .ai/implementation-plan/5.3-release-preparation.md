...
- *Tasks*:
  ...
  - [ ] Prepend copyright notice to LICENSE: `Copyright © 2025 <C-Corp Name>`
  - [ ] Update package.json license field from "MIT" to "Apache-2.0"
  - [ ] Update README.md license section from "MIT" to "Apache 2.0"
  - [ ] Update README "License" section to name <C-Corp Name> as maintainer
  ...
  - [ ] Add copyright notice header: `// Copyright © 2025 <C-Corp Name>`
