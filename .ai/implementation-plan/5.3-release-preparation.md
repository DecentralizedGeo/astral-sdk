...
- _Tasks_:
  ...
  - [ ] Update npm org profile to list Sophia Systems Corporation as copyright holder
  - [ ] **COMMIT**: `legal: establish corporate ownership structure`

  #### **Sub-task 1D: Contributor License Agreement (CLA) Setup**

  - [ ] JOHN: Upload CLA (individual + entity versions) naming Sophia Systems Corporation as assignee
  - [ ] JOHN: Configure CLA-assistant on GitHub repository
