...
export interface PublicationRecord {
  ...
  readonly metadata?: Record<string, any>; // CLAUDE: What is this for???
}
...
export interface OffchainProofOptions extends ProofOptions {
  readonly signer?: any; // Will be refined to ethers.Signer once we have the dependency
...
export interface OnchainProofOptions extends ProofOptions {
  readonly chain?: string;
  readonly txOverrides?: Record<string, any>; // CLAUDE: What is this for???
...
export interface AstralSDKConfig {
  ...
  readonly provider?: any; // Will be refined to ethers.Provider
  readonly signer?: any; // Will be refined to ethers.Signer
